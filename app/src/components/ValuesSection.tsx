    ...
    <section className="values-section section">
      <div className="container">
        <div className="values-header">
          <h2 className="section-title">Jsme tým profesionálů s vášní pro detail</h2>
        ...
        <div className="values-grid">
          <div className="value-card quality-card">
            ...
            <h3 className="value-title">KVALITA</h3>
            <p className="value-description">
              Používáme pouze prvotřídní materiály a nejmodernější technologie
            </p>
          </div>
          
          <div className="value-card precision-card">
            <div className="value-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
              </svg>
            </div>
            <h3 className="value-title">PRECIZNOST</h3>
            <p className="value-description">
              Každý detail dotahujeme k dokonalosti
            </p>
          </div>
          
          <div className="value-card satisfaction-card">
            <div className="value-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
              </svg>
            </div>
            <h3 className="value-title">SPOKOJENOST</h3>
            <p className="value-description">
