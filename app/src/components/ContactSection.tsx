    ...
    <section className="contact-section section" id="contact">
      <div className="container">
        <div className="contact-header">
          <h2 className="section-title">Pojďme si promluvit o vašem projektu</h2>
        ...
        <div className="contact-content">
          ...
          <div className="contact-form-container">
            <form className="contact-form">
              ...
              <div className="form-row">
                <div className="form-group">
                  <label htmlFor="budget">Přibližný rozpočet (volitelné)</label>
                ...
                <div className="form-group">
                  <label htmlFor="timeline">Kdy by měla realizace proběhnout?</label>
        ...
        <div className="service-area">
          ...
          <div className="service-regions">
            <span className="region">Brno</span>
            <span className="region">Ostrava</span>
            <span className="region">Olomouc</span>
            <span className="region">Zlín</span>
            <span className="region">Jihlava</span>
            <span className="region">Praha</span>
          </div>
        </div>
      </div>
