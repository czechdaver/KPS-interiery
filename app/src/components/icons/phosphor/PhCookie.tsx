...
export interface PhCookieProps {
  size?: string | number;
  style?: any;
  class?: string;
}
...
/**
 * PhCookie - Duotone Phosphor Icon
 *
 * Replacement for: <i class="ph-duotone ph-cookie" style="font-size: 24px;"></i>
 * Usage: <PhCookie size={24} class="icon-duotone-reverse" />
 *
 * Supports:
 ...
 */
export const PhCookie = component$<PhCookieProps>(({
  size,
  style,
  class: className,
  ...props
