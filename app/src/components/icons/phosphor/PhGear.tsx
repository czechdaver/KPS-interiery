...
/**
 * PhGear - Duotone Phosphor Icon
 *
 * Replacement for: <i class="ph-duotone ph-gear" style="font-size: 24px;"></i>
 * Usage: <PhGear size={24} class="icon-duotone-reverse" />
 *
 * Supports:
 ...
 */
export const PhGear = component$<PhGearProps>(({
  size,
  style,
  class: className,
  ...props
