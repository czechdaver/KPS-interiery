...
export interface PhBathtubProps {
  size?: string | number;
  style?: any;
  class?: string;
}
...
/**
 * PhBathtub - Duotone Phosphor Icon
 *
 * Replacement for: <i class="ph-duotone ph-bathtub" style="font-size: 24px;"></i>
 * Usage: <PhBathtub size={24} class="icon-duotone-reverse" />
 *
 * Supports:
 ...
 */
export const PhBathtub = component$<PhBathtubProps>(({
  size,
  style,
  class: className,
  ...props
