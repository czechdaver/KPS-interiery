...
export interface PhCrosshairProps {
  size?: string | number;
  style?: any;
  class?: string;
}
...
/**
 * PhCrosshair - Duotone Phosphor Icon
 *
 * Replacement for: <i class="ph-duotone ph-crosshair" style="font-size: 24px;"></i>
 * Usage: <PhCrosshair size={24} class="icon-duotone-reverse" />
 *
 * Supports:
 ...
 */
export const PhCrosshair = component$<PhCrosshairProps>(({
  size,
  style,
  class: className,
  ...props
