...
/**
 * PhPhone - Duotone Phosphor Icon
 *
 * Replacement for: <i class="ph-duotone ph-phone" style="font-size: 24px;"></i>
 * Usage: <PhPhone size={24} class="icon-duotone-reverse" />
 *
 * Supports:
 ...
 */
export const PhPhone = component$<PhPhoneProps>(({
  size,
  style,
  class: className,
  ...props
