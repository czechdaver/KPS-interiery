...
export interface PhImagesProps {
  size?: string | number;
  style?: any;
  class?: string;
}
...
/**
 * PhImages - Duotone Phosphor Icon
 *
 * Replacement for: <i class="ph-duotone ph-images" style="font-size: 24px;"></i>
 * Usage: <PhImages size={24} class="icon-duotone-reverse" />
 *
 * Supports:
 ...
 */
export const PhImages = component$<PhImagesProps>(({
  size,
  style,
  class: className,
  ...props
