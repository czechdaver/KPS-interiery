...
/**
 * PhHeart - Duotone Phosphor Icon
 *
 * Replacement for: <i class="ph-duotone ph-heart" style="font-size: 24px;"></i>
 ...
 */
export const PhHeart = component$<PhHeartProps>(({
  size,
  style,
  class: className,
  ...props
