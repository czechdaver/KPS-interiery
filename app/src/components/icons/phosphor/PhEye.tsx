...
/**
 * PhEye - Duotone Phosphor Icon
 *
 * Replacement for: <i class="ph-duotone ph-eye" style="font-size: 24px;"></i>
 * Usage: <PhEye size={24} class="icon-duotone-reverse" />
 *
 * Supports:
 ...
 */
export const PhEye = component$<PhEyeProps>(({
  size,
  style,
  class: className,
  ...props
